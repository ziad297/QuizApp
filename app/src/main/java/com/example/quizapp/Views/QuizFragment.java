...
public class QuizFragment extends Fragment implements View.OnClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable  Bundle savedInstanceState) {
        ...
        totalQuestions = QuizFragmentArgs.fromBundle(getArguments()).getTotalQues();
    ...
    private void resetOptions(){
        ...
        option1Btn.setBackground(ContextCompat.getDrawable(getContext() , R.drawable.button_style));
        option2Btn.setBackground(ContextCompat.getDrawable(getContext() , R.drawable.button_style));
        option3Btn.setBackground(ContextCompat.getDrawable(getContext() ,R.drawable.button_style));
    }
    ...
    private void submitResults() {
        ...
        com.example.quizapp.Views.QuizFragmentDirections.ActionQuizFragmentToResultFragment action =
